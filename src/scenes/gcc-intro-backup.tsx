...
export default makeScene2D(function* (view) {
  ...
  // Slide 4: Processo di Compilazione
  ...
  // Container box con bordo tratteggiato (più grande)
  view.add(
    <Rect
      ref={containerBox}
      width={1300}
  ...
  // Nascondi slide 4 fasi
  yield* all(
    phasesTitle().opacity(0, 0.5),
    phasesSubtitle().opacity(0, 0.5),
    containerBox().opacity(0, 0.5),
    arrowIn().opacity(0, 0.5),
    preBox().opacity(0, 0.5),
    preText().opacity(0, 0.5),
    preDesc().opacity(0, 0.5),
    arrowPre().opacity(0, 0.5),
    compBox().opacity(0, 0.5),
    compText().opacity(0, 0.5),
    compDesc().opacity(0, 0.5),
    arrowComp().opacity(0, 0.5),
    asmBox().opacity(0, 0.5),
    asmText().opacity(0, 0.5),
    asmDesc().opacity(0, 0.5),
    arrowAsm().opacity(0, 0.5),
    linkBox().opacity(0, 0.5),
    linkText().opacity(0, 0.5),
    linkDesc().opacity(0, 0.5),
    arrowOut().opacity(0, 0.5),
  );
